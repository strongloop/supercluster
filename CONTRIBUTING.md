...
Thank you for your interest in `supercluster`, an open source project
administered by StrongLoop.

Contributing to `supercluster` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/supercluster)
